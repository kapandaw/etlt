	...
	function() {
		...
		a = function(a, b) {
			...
			return null == b ? a.error("Vex is required to use vex.dialog") : (c = function(b) {
				...
				onSubmit: function(e) {
					var f, g;
					return f = a(this), g = f.parent(), e.stopPropagation(), g.data().vex.value = d.getFormValueOnSubmit(c(f)), b.close(g.data().vex.id);
					// e.preventDefault(), 
				},
				focusFirstInput: !0
				...
				var c, e, f;
				return c = a('<form id="vex-form" class="vex-dialog-form" method="POST" role="form" />'), f = a('<div class="vex-dialog-message" />'), e = a('<div class="vex-dialog-input" />'), c.append(f.append(b.message)).append(e.append(b.input)).append(d.buttonsToDOM(b.buttons)).bind("submit.vex", b.onSubmit), c
